...
(function() {
	...
	arrayWillChange: function(key, collection, start, removeCount, addCount) {
	    var store = this.get('store');

	    store.arrayWillChange(this, key, collection, start, removeCount, addCount);
	},
	...
	*/
	...
	arrayWillChange: function(ob, key, collection, start, removeCount, addCount) {
	    // var store = this;
	    // var values = collection.slice(start, start + removeCount);
	    // values.forEach(function(value) {
	...
	arrayDidChange: function(ob, key, collection, start, removeCount, addCount) {
		...
		var valueIds = values.map(function(value) {
